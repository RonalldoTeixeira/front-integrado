...
const FeedComments = () => {
    ...
    const getComments = () => {
        axios.get(
            `https://labeddit-backend-slzf.onrender.com/comments?q=${searchPost[0].id}`,
            {
                headers: {
                    Authorization: token
                }
    ...
    const createComments = () => {
        ...
        axios.post(
            `https://labeddit-backend-slzf.onrender.com/comments/${searchPost[0].id}`,
            body,
            {
                headers: {
                    Authorization: token
    ...
    const getPost = () => {
        axios.get(
            `https://labeddit-backend-slzf.onrender.com/posts?q=${searchPost[0].id}`,
            {
                headers: {
                    Authorization: token
                }
